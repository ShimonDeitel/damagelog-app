...
final class Store: ObservableObject {
    ...
    private let fileName = "damagelog_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Damage Entry One", detail: "First example entry.", date: now),
            Entry(title: "Sample Damage Entry Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Damage Entry Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
